...
{% endcomment %}
{% assign series_defs = "1990년대 연애·육성 시뮬레이션|연애시뮬레이션,아이돌마스터의 역사|아이돌마스터,코에이 삼국지|삼국지,코에이 노부나가의 야망|노부나가의야망,코에이 대항해시대|대항해시대,코에이 리코에이션 게임|리코에이션,일본 PC의 시대|일본PC" | split: "," %}
