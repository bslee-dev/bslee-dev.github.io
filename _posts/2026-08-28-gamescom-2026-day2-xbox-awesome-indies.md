...
앞선 [게임스컴 2026 Opening Night Live 총정리](/2026/08/26/gamescom-onl-2026-summary/)와 [Day 1 총정리 — Xbox·Future Games Show·밤사이 추가 발표](/2026/08/27/gamescom-2026-day1-xbox-future-games-show/)에 이어, 이번에는 **한국 시간 8월 27일 밤부터 28일 오전 사이**에 진행된 Xbox @ gamescom Day 2와 gamescom awesome indies, 그리고 같은 날 현장에서 추가로 구체화된 소식을 묶었다.
...
둘째 날은 대형 퍼스트파티 신작 하나가 모든 관심을 가져가기보다, 중견·인디 게임의 일정과 Game Pass 합류가 한꺼번에 채워진 것이 특징이었다.
...
2일차 방송과 현장 발표에서 날짜 또는 구체적인 출시 시기가 확인된 주요 작품을 추리면 다음과 같다.

| 게임 | 일정 | 2일차에서 확인된 내용 |
|---|---:|---|
| Albion Online: Dragonfire | 2026-08-31 | 신규 콘텐츠 소개 |
| Dune: Awakening 콘솔판 / Filmic Archive | 2026-09-22 | PS5·Xbox판, DLC, Game Pass 및 향후 크로스플레이 계획 |
| Dragon's Dogma 2: Dark Arisen | 2026-10-09 | Norgan 지역과 새 던전·장비 시스템 시연 |
| Deep Dish Dungeon | 2026-10-13 | 출시일 확정, Game Pass |
| Planet Zoo 2 | 2026-10-13 | Wildlife Reserves 추가 소개 |
| DayZ: Badlands | 2026-10-15 | Nasdara 사막 지역 출시일 확정 |
| The Séance of Blake Manor | 2026-10-27 | Xbox Series X\|S·Xbox PC, Game Pass |
| Armatus | 2027-01-07 | 출시일 확정, Game Pass |
| Stranger Than Heaven | 2027-01-15 | 장시간 추가 시연, Game Pass 재확인 |
| Cassette Beasts 2002 | 2027년 3월 | 출시 시기 최초 확정 |
| Son of Thanjai | 2027년 봄 | PS5 / Xbox Series / PC, Game Pass |
| Alien Deathstorm | 2027년 봄 | 출시 시기 확정, Game Pass |
| Turok: Origins | 2027년 봄 | 확장 게임플레이 공개 |
| Rogue Fortune | 2027 | 신작 최초 공개 |
| Holstin | 2027 | 출시 플랫폼·Game Pass 확정 |
| Militsioner | 2027 | Xbox Series X\|S·Xbox PC·Game Pass·Play Anywhere |
| Kingdom 3: Rising Realms | 2027 | 확장 게임플레이 공개 |
...
특징은 유물인 `Relic`의 배치다. 단순히 좋은 장비를 주워 수치를 올리는 방식이 아니라, 기하학적인 모양의 유물을 조합하고 서로 인접시켜 효과를 증폭하거나 연쇄 효과를 만드는 구조다. 하나의 유물을 옮기는 것만으로 전체 빌드가 강해지거나 무너질 수 있다는 설명도 붙었다.

그리고 제목 그대로 "행운"을 어디까지 걸 것인지가 진행에 들어간다. 이미 확보한 재산을 지킬지, 생존 확률을 높이는 데 쓸지, 더 큰 힘을 위해 다시 걸지를 선택한다.

- 개발·퍼블리싱: Glowmade
- 장르: 로그라이트 액션
- 출시: 2027
- 플랫폼: PS5 / Xbox Series X\|S / Switch 2 / PC

Day 1의 Xbox 신작이 Dumpster Gang이나 Terrible Lizards처럼 협동·기괴한 콘셉트에 치우쳤다면, Day 2의 새 얼굴은 좀 더 전통적인 액션 로그라이트 쪽이었다.
...
이 게임이 흥미로운 이유는 거대한 존재가 단순 보스가 아니라 **도시 전체의 감시 시스템이자 하나의 NPC**처럼 기능한다는 점이다. 어떤 방식으로 탈출할지를 플레이어에게 맡기는 immersive sim의 자유도를 아주 기괴한 장치로 표현한 셈이다.

- 출시: 2027
- 플랫폼: Xbox Series X\|S / Xbox PC
- Xbox Game Pass 포함
...
구조는 3인칭 로그라이트 슈터다. 총기와 낫, 천상의 능력을 함께 사용하며 한 번 죽으면 다시 살아나 다음 런을 시작한다. SMG와 샷건 같은 총기뿐 아니라 holy fire, 시간 감속 같은 능력을 조합해 진행할수록 훨씬 과격한 빌드를 만드는 방향이다.

- 개발: Counterplay Games
- 퍼블리셔: Fictions
- 출시: 2027-01-07
- 플랫폼: PS5 / Xbox Series X\|S / Switch 2 / PC
- Xbox Game Pass 포함
...
픽셀 아트 세계를 실시간 조명과 3D 공간으로 구현하고, 상황에 따라 카메라가 바뀐다. 마을 탐색에서는 아이소메트릭 시점을 쓰다가 전투에서는 어깨 너머 시점으로 전환하고, 운전에서는 1인칭, 다른 구간에서는 탑다운이나 횡스크롤 시점까지 사용한다. 카메라는 여덟 방향으로 돌릴 수 있다.

한 가지 시점 규칙에 얽매이지 않고 장면에 따라 가장 효과적인 화면을 골라 쓰는 셈이다. 픽셀 호러인데도 단순한 고전 게임 재현처럼 보이지 않는 이유가 여기에 있다.

- 출시: 2027
- 플랫폼: PS5 / Xbox Series X\|S / Switch / PC
- Xbox Game Pass 포함
...
게임에서 고대·중세 유럽이나 일본이 아니라 **남인도의 특정 왕조와 도시를 정면으로 중심 무대에 놓은 액션 어드벤처**라는 점이 꽤 드물다. 개발사가 공개한 gamescom 영상도 실제 게임플레이를 바탕으로 만들어졌다고 설명했다.
...
게임의 중심은 총을 들고 유령을 잡는 것이 아니라 사람을 인터뷰하고, 증거와 동기를 기록하고, 모순을 찾아 추궁하는 탐정 과정이다. Xbox Day 2가 대형 액션 게임만 보여준 방송이 아니었다는 것을 잘 보여주는 작품이기도 하다.
...
크로스플레이는 콘솔 출시 이후 추가할 계획이라고 공식 확인됐다. 정확한 적용 날짜는 아직 공개되지 않았다.

- 콘솔판 출시: 2026-09-22
- Filmic Archive DLC: 2026-09-22
- Xbox Game Pass: 2026-09-22
- PS5 Pro 포함 콘솔 게임플레이 공개
- 크로스플레이: 출시 후 추가 예정

기존 PC 게임의 단순 이식이라기보다 9월 22일을 기준으로 플랫폼과 플레이 방식이 한꺼번에 넓어지는 업데이트에 가깝다.
...
주인공 다이토 마코토가 거리 싸움에서 살아남는 동시에 음악적 재능을 바탕으로 쇼맨으로 성장한다. 기존 용과 같이 계열에서 익숙한 난투를 유지하면서도 한 사람의 삶과 도시의 시간을 훨씬 긴 폭으로 추적하는 작품이라는 점이 점점 분명해지고 있다.

- 개발: Ryu Ga Gotoku Studio
- 출시: 2027-01-15
- PS5 / Xbox Series X\|S / Xbox PC / Steam
- Xbox Game Pass 포함
...
현장 플레이 기사에서는 `spoils`라는 장비 감정 구조, 기존 세계에 추가되는 12개의 던전 도전, 새 적과 보스, 기존 vocation의 강화 기술 등이 확인됐다.

- 출시: 2026-10-09
- 플랫폼: PS5 / Xbox Series X\|S / PC / Switch 2

이번 Day 2에서 날짜 자체보다 **Dark Arisen이 Dragon's Dogma 2의 약점을 어떤 방식으로 보완하려 하는지**가 조금 더 보이기 시작했다.
...
개발사는 플레이어가 훈련된 슈퍼 솔저가 아니라 기본 전투 훈련만 받은 엔지니어라는 점을 강조한다. 권총·SMG·샷건 같은 총기 외에 장비를 수리하는 망치, 위협을 탐지하는 Geiger Scanner, 플레어 같은 도구를 함께 사용한다.

적은 미리 정해진 위치에서만 튀어나오기보다 플레이 상황에 맞춰 추적하고 공격한다. gamescom 시연용 Reactor 임무 역시 플레이할 때마다 같은 흐름으로 진행되지 않는다고 설명했다.

- 개발: Rebellion
- 출시: 2027년 봄
- Xbox Series X\|S / Xbox PC
- Xbox Game Pass 출시 첫날 포함

## Xbox Day 2의 나머지 주요 발표

둘째 날 Xbox 방송은 신규 발표와 함께 이미 알려진 대작을 길게 보여주는 구성이 섞였다.

| 게임 | Day 2에서 나온 내용 |
|---|---|
| Microsoft Flight Simulator 2024 | 이탈리아 City Update와 National Championship Air Races 추가 소개 |
| PUBG: DED.NET | `Fresh Meat` 신규 트레일러 공개 |
| Stuntman: Hollywood | Jurassic World에서 영감을 받은 스턴트 시퀀스 공개 |
| Turok: Origins | 공룡 전투 중심의 확장 게임플레이, 2027년 봄 |
| Planet Zoo 2 | 동물을 더 넓은 자연 환경에 배치하는 Wildlife Reserves 소개, 10월 13일 |
| Call of Duty: Modern Warfare 4 | 추가 게임플레이와 오픈 베타 관련 소개 |
| Kingdom 3: Rising Realms | 왕국 운영·방어 구조의 확장 게임플레이, 2027 |
| Tides of Annihilation | 추가 게임플레이 소개 |
| Arkheron | 멀티플레이 관련 추가 소개 |
| What Goes Up | 물건을 쌓아 올리는 협동 물리 게임 신규 공개, 2026·Game Pass |

Xbox Day 1이 Fable·Tomb Raider의 긴 시연과 Disc-to-Digital이라는 플랫폼 정책으로 기억됐다면, Day 2는 훨씬 많은 게임에 **구체적인 날짜와 Game Pass 표식**을 붙이는 방송이었다.

## Awesome Indies — 34개의 작은 게임이 한 시간 남짓에 몰렸다
...
개발팀이 gamescom에 가져온 프리뷰 빌드는 약 45분 분량이며 두 개의 전투 상황과 세 개의 결말, 개편된 대화·인벤토리·튜토리얼 시스템을 포함한다. 공개 예정인 데모는 이 프리뷰보다 더 확장된 버전이 될 예정이다.
...
행사 정리 페이지에 잡힌 34개 작품은 다음과 같다.

| 작품 | 작품 |
|---|---|
| Neon Hyperdrive | Cairn: On the Trail |
| Cat Secretary | Odd Town |
| Caaahr! | Food Truck Empire |
| Chronoscript: The Endless End | Wishseeker |
| Tanuki: Pon's Summer | 4AM |
| Far Far West | Pipes.exe |
| About Cannons & Sparrows | Duskfade |
| Glasshouse | Snowtracked |
| Inferius | Deck of Memories |
| Inkblood | Sated |
| DeadRoot | Usual June |
| Deadly Days: Roadtrip | Agni: Village of Calamity |
| SacriFire | Book Nook |
| Appulse | Isle Goblin |
| Nine Rounds Rapid | There Are No Ghosts at the Grand |
| Conquista: Tide of Wills | Dungeon Lurker |
| Future? No Thanks! | Being & Becoming |

ONL이나 Xbox 방송만 따라가면 이 목록의 대부분은 아예 보이지 않는다. gamescom이 큰 퍼블리셔의 발표회이면서 동시에 수백 개 작은 개발팀이 모이는 박람회라는 사실은 오히려 이런 방송에서 더 잘 드러난다.

## 1일차와 비교하면 무엇이 달랐나

[Day 1](/2026/08/27/gamescom-2026-day1-xbox-future-games-show/)은 성격이 분명했다.

Xbox에서는 Disc-to-Digital이라는 플랫폼 정책이 나왔고, Fable과 Tomb Raider는 실제 플레이 수준으로 깊게 공개됐다. 이어진 Future Games Show에서는 Wolcen 2, Greak 2, Dungeons & Dragons: Long Rest Tavern처럼 ONL에 없던 신작이 대량으로 추가됐다.

Day 2는 그보다 덜 화려하다. 대신 실제로 구매하거나 Game Pass에서 플레이할 시점을 정리하기에는 오히려 정보가 많았다.
...
따라서 이번 글은 **2일차 밤사이 발표까지의 기록**으로 끊고, 이후 수상작이나 주말에 새로 나온 발표는 별도로 보는 편이 맞다.
...
- [Pure Xbox — Xbox gamescom Day 2 주요 발표](https://www.purexbox.com/news/2026/08/xboxs-second-gamescom-2026-stream-included-tons-of-surprise-announcements)
- [Xbox Wire — Militsioner, 2027년 Game Pass](https://news.xbox.com/en-us/2026/08/27/militisioner-coming-to-game-pass/)
- [Xbox Wire — Alien Deathstorm gamescom 트레일러](https://news.xbox.com/en-us/2026/08/27/five-key-takeaways-new-alien-deathstorm-trailer/)
- [Gematsu — Rogue Fortune 발표](https://www.gematsu.com/2026/08/fast-paced-roguelite-action-game-rogue-fortune-announced-for-ps5-xbox-series-switch-2-and-pc)
- [Gematsu — Armatus 2027년 1월 7일](https://www.gematsu.com/2026/08/armatus-launches-january-7-2027)
- [Gematsu — Holstin 2027년](https://www.gematsu.com/2026/08/holstin-launches-in-2027)
- [Gematsu — Son of Thanjai 2027년 봄](https://www.gematsu.com/2026/08/son-of-thanjai-launches-in-spring-2027)
- [Raw Fury — Deep Dish Dungeon 10월 13일](https://rawfury.com/deep-dish-dungeon-date-reveal/)
- [DayZ Steam — Badlands 10월 15일](https://store.steampowered.com/news/posts/?appids=221100&feed=steam_community_announcements)
- [Dune: Awakening — gamescom 발표](https://duneawakening.com/news/dune-awakening-at-gamescom-ps5-gameplay-filmic-archive-dlc-and-cross-play-confirmed-for-post-launch/)
- [Xbox — Stranger Than Heaven](https://www.xbox.com/ko-KR/games/stranger-than-heaven)
- [gamescom — awesome indies 2026](https://www.gamescom.global/en/event/gamescom-awesome-indies-2026)
- [Teams Finder — Awesome Indies 2026 등장작 목록](https://www.theteamsfinder.com/en/events/cmt874odp00690jpo9x6lv4e5)
- [Shueisha Games — Chronoscript: The Endless End](https://shueisha-games.com/news/20260608_chronoscript-the-endless-end/)
- [Steam — There Are No Ghosts at the Grand](https://store.steampowered.com/app/3725190/There_Are_No_Ghosts_at_the_Grand/)
